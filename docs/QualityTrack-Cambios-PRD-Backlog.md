...
Este documento lista lo que el trabajo de esquema devuelve hacia atrás. **Ninguno de los 14 puntos cambia el flujo acordado — todos lo precisan.** Todas las definiciones ya fueron tomadas; lo que queda es aplicarlas a los documentos.
