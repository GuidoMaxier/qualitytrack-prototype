...
Versión 2 · 04/09/2026 · Derivado de la Especificación Funcional v2 (`QualityTrack-PRD-v2.md`)

*Esta versión aplica las 15 definiciones y correcciones documentadas en `QualityTrack-Cambios-PRD-Backlog.md`, validadas con el equipo completo el 04/09/2026. Los cambios de criterios de aceptación están marcados con **(v2)**. HU-5.2 se elimina — ver CA-1 en el documento de cambios.*
